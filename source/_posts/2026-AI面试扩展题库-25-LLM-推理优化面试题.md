---
title: "AI 面试扩展题库 25：LLM 推理优化面试题"
...
> 本篇是完整扩展整理，来源于 [ai-interview-guide](https://github.com/guocong-bincai/ai-interview-guide) 的 `docs/08-inference-optimization/README.md`。前面的“AI 面试知识库”16 篇是主线总纲，这一组用于保留原始项目里的密集题库、长答案、示例和项目细节。
...
- 原文档路径：`docs/08-inference-optimization/README.md`
