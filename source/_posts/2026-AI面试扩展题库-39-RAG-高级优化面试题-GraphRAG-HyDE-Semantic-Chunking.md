---
title: "AI 面试扩展题库 39：RAG 高级优化面试题（GraphRAG / HyDE / Semantic Chunking）"
date: 2026-07-07 23:59:21
categories:
  - AI Career
tags:
  - AI-Interview
...
> 本篇是完整扩展整理，来源于 [ai-interview-guide](https://github.com/guocong-bincai/ai-interview-guide) 的 `docs/20-rag-advanced-optimization/README.md`。前面的“AI 面试知识库”16 篇是主线总纲，这一组用于保留原始项目里的密集题库、长答案、示例和项目细节。
...
- 第一遍按目录快速扫问题，先建立知识地图。
- 第二遍把每个 Q/A 改写成自己的 60 秒口述答案。
- 第三遍结合项目经历补充“我做过什么、指标如何变化、踩过什么坑”。

## 来源

- [ai-interview-guide](https://github.com/guocong-bincai/ai-interview-guide)
- 原文档路径：`docs/20-rag-advanced-optimization/README.md`
