---
title: "AI 面试扩展题库 07：06｜多智能体系统（Multi-Agent Systems）"
date: 2026-07-07 23:59:53
categories:
  - AI Career
tags:
  - AI-Interview
...
> 本篇是完整扩展整理，来源于 [ai-agent-interview-guide](https://github.com/bcefghj/ai-agent-interview-guide) 的 `docs/01-面试八股文/06-多智能体.md`。前面的“AI 面试知识库”16 篇是主线总纲，这一组用于保留原始项目里的密集题库、长答案、示例和项目细节。
...
- 原文档路径：`docs/01-面试八股文/06-多智能体.md`
