---
title: "AI 面试扩展题库 01：AI Agent 从零到 Offer：完整学习路线图"
...
> 本篇是完整扩展整理，来源于 [ai-agent-interview-guide](https://github.com/bcefghj/ai-agent-interview-guide) 的 `docs/00-学习路线图/README.md`。前面的“AI 面试知识库”16 篇是主线总纲，这一组用于保留原始项目里的密集题库、长答案、示例和项目细节。
