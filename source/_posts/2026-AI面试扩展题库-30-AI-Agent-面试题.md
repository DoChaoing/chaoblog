---
title: "AI 面试扩展题库 30：AI Agent 面试题"
date: 2026-07-07 23:59:30
categories:
  - AI Career
tags:
  - AI-Interview
...
> 本篇是完整扩展整理，来源于 [ai-interview-guide](https://github.com/guocong-bincai/ai-interview-guide) 的 `docs/13-multi-agent-systems/README.md`。前面的“AI 面试知识库”16 篇是主线总纲，这一组用于保留原始项目里的密集题库、长答案、示例和项目细节。
...
- 原文档路径：`docs/13-multi-agent-systems/README.md`
